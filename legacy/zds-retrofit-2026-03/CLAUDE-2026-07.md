...
**Vault Project:** `/Users/patdubois/patdubois/Projects/Pedes App/Pedes App.md`
**Old Vault Note:** `/Users/Shared/pat-dubois/02 Projects/Personal/Pediatric Nutrition Calculator.md`
...
- Crystal validated Health Canada 2023 formulas - correct
- Added kcal/kg/day display per Crystal's request
- Added animated number counters and staggered card reveals
- Deployed and live at https://pat-dubois.github.io/peds-nutrition-calc/
...
### Next Session TODO
1. Crystal requested upgrade - scope and build session
2. v2 enhancements: Gus sprite, pencil animation, copy-to-clipboard, PWA

### System Integration
- **Code:** `/home/tili/sidequests/pedes-app/` (crossed to the VPS house 2026-07-07; Mac origin copy was `~/dev/Lab/personal/crystal/pedes-app/`)
- **Vault project note:** `/Users/patdubois/patdubois/Projects/Pedes App/Pedes App.md` (Obsidian, on the Macs)
- **GitHub:** https://github.com/pat-dubois/peds-nutrition-calc
- **Tili:** always-on home is `/home/tili/` on tili-vps - can research formulas, test, assist overnight